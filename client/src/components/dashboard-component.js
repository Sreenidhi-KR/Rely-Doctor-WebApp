...
export default function Dashboard() {
  ...
  useEffect(async () => {
    const fetchData = async () => {
      ...
      console.log("ccccccccccccccon",consultations)
        ...
        <div className="row" style={{ display: "-webkit-inline-box" }}>
          <div class="column" style={{ display: "inline-grid" }}>
            <div class="tile job">
              <div class="header">
                {isLoading ? (
                  <div class="count">
                    <div class="loader" style={{ marginLeft: "70px" }}></div>
                  </div>
                ) : (
                  <div class="count">{consultations.length}</div>
                )}
              </div>
              <div class="body">
                ...
                <div class="header">
                  {isLoading ? (
                    ...
                    <div class="count">
                      ...
                      <FontAwesomeIcon
                        icon={faStar}
                        style={{ color: "#f9b41f", marginLeft: "3px" }}
                      />
                    </div>
                  )}
                </div>
          ...
          <div className="column" style={{ display: "contents" }}>
            ...
            >
              <div
                class="card-header"
                style={{ fontWeight: "bold", color: "#5e17eb" }}
              >
                          ...
                          consultations?.map((consultation) => (
                            ...
                            >
                              <div class="flex-column">
                                ...
                                {consultation.documentDetailsList.map(
                                  (documents) => (
                                    <span
                                      ...
                                      onClick={() =>
                                        AuthService.downloadPatientDocument(
                                          documents.id,
                                          documents.name
                                        )
                                      }
